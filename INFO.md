...
| <a name="module_controllers"></a> [controllers](#module\_controllers) | ./modules/compute | n/a |
...
| <a name="module_workers"></a> [workers](#module\_workers) | ./modules/compute | n/a |
...
| <a name="input_controller_count"></a> [controller\_count](#input\_controller\_count) | The number of control instances to create | `number` | `1` | no |
